(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["pocketfree\\\\.in(?:/.*)?/ola/services/.*","pocketfree\\\\.in/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://3ceb84e9-713e-49e4-bb08-047e3fd70057\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["pocketfree\\\\.in(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/3ceb84e9-713e-49e4-bb08-047e3fd70057/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/3ceb84e9-713e-49e4-bb08-047e3fd70057/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/"]').map((e => ({
                url: e,
                revision: "1693157624577"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("pocketfree.in-"))).map((e => caches.delete(e))))
            })))
